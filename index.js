...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:criador\n' // nome do dono (cuss vulgo JAPA) 
            + 'ORG:bot;\n' // nome do bot 
            + 'TEL;type=CELL;type=VOICE;waid=+554797935071 :+55 4797935071 \n' //Número do zape
            + 'END:VCARD'
prefix = '/'
emoji = '⛩️️' 
botname = 'botdojapa' 
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["554797935071@s.whatsapp.net","17404627820@s.whatsapp.net"] // número de dono 
			const mod = [ownerNumber,"554797935071@s.whatsapp.net","17404627820@s.whatsapp.net"]//número de mod/dono 
			const adminbotnumber = ["554797935071@s.whatsapp.net","17404627820@s.whatsapp.net"]//número de adm
			const frendsowner = ["554797935071@s.whatsapp.net","17404627820@s.whatsapp.net"]//número de "amigos" (arrumar definição) 
			const premium = ["554797935071@s.whatsapp.net","17404627820@s.whatsapp.net"] // Premium
			...
			switch(command) {
				...
				case 'menu':
                    ...
                    uptime=process.uptime 
                       client.sendMessage(from, help(prefix, emoji), text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "*WhatsApp BOT*", 'jpegThumbnail': fs.readFileSync('./assets/botlogo.webp')}}}})
                    break
				case 'help1':
				case 'menu1':
			...
			case 'instaimg':
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS JAPA BOT 👑* 」\n\`\`\``
					no = 0
			...
			break
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o JAPA ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT JAPA ✨* 」\n*│+ wa.me/5547992091566*╰──────*「 *JAPA* 」*────*\n\n*_SE QUER SER ADMIN DO BOT JAPA_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/554797935071/*╰──────*「 * JAPA* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO JAPA BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do JAPA:*\n\n https://youtube.com/c/JAPA777xs'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
